...
def get_alpha(rotation_y, x, z):
    alpha = rotation_y
    alpha -= -math.atan2(z, x) - 1.5*math.pi
...
class KittiConverter:
    def __init__(self,
        ...
        self.nusc = NuScenes(version=nusc_version, dataroot='/next/u/patcho/cs231n/nuscenes')
        ...
        for sample_token in sample_tokens:
            ...
            with open(label_path, "w") as label_file:
                for sample_annotation_token in sample_annotation_tokens:
                    ...
                    alpha = get_alpha(yaw, box_cam_kitti.center[0], box_cam_kitti.center[2])
